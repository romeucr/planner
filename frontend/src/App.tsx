...
export function App() {
  ...
  function removeEmailFromInvites(emailToRemove: string) {
    const newEmailList = emailsToInvite.filter(item => item !== emailToRemove)
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className="flex item gap-2 flex-1">
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' onClick={openGuestsModal} className="flex item gap-2 flex-1 text-left">
